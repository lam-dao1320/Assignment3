...
for(a=0; a<dayList.length; a++){
    dayList[a].addEventListener('click', function(e){
...
clearButt.addEventListener('click', function(e){
    for(a=0; a<dayList.length; a++){
        dayList[a].classList.remove('clicked');
    }
    dayCounter=0;
    calculateCost();
})
...
/********* calculate *********/
// when a calculation is needed, set the innerHTML of the calculated-cost element to
